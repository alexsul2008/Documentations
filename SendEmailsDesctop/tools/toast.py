...
from PySide2.QtCore import QTimer, Qt, QPropertyAnimation, QAbstractAnimation, QPoint
from PySide2.QtGui import QIcon, QFont, QColor
from PySide2.QtWidgets import QWidget, QLabel, QHBoxLayout, QGraphicsOpacityEffect, QMainWindow
...
class Toast(QMainWindow):
    def __init__(self, text, duration=10, parent=None):
        super().__init__()
        print(f'{self=}')
